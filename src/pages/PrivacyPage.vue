<template>
  <q-page>
    <div class="row q-px-lg">
      <div class="col">
        <h1>UCrisko, LLC. Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to UCrisko, LLC., 3302 Woodhill Cir, Superior Twp, MI 48198.
            </p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to UCrisko, LLC., accessible from <a href="https://www.ucrisko.com"
                                                                                    rel="external nofollow noopener"
                                                                                    target="_blank">https://www.ucrisko.com</a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: info@ucrisko.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://www.ucrisko.com/privacy"
                                                        rel="external nofollow noopener" target="_blank">https://www.ucrisko.com/privacy</a>
            </p>
          </li>
        </ul>
      </div>
