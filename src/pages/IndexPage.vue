<template>
  <q-page>
    <div id="main-heading-container" class="flex justify-center q-pa-sm">
      <h1 class="text-h2 q-mb-xl">Business and Academic Web Solutions</h1>
    </div>

    <div id="why-uc-section">
      <div id="why-uc-section-header" class="bg-red-10">
        <h2 class="heading text-h4 text-grey-3">
          Why should you choose UCrisko?
        </h2>
      </div>
    ...
    <div id="index-footer" class="q-mt-xl bg-blue-grey-10">
      <div class="row">
        <div class="col q-ma-xl">&copy; 2023 UCrisko, LLC.</div>
      </div>
    </div>
